...
class Workspace extends ExtensibleElement implements Model\Workspace
{
    public function __construct($factory) {
        parent::__construct(Constants::WORKSPACE, null, Constants::APP_NS, $factory);
    }

    public function addCollection(Model\Collection $collection) {
